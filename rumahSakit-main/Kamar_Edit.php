                            ...
                            ?>
                                ...
                                <form class="col-12" action="Kamar_Edit1.php" method="post" name="form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="id_kamar" value="<?php echo $id_kamar;?>" readonly>
                                    
                                    <div class="form-group">
                                        <label for="name">Nama Kamar</label>
                                        <input type="text" class="form-control" name="nama_kamar" value="<?php echo $namakamar;?>">
