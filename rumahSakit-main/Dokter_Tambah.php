        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <table class="table1 table table-bordered">
                    <thead>
                        <tr>
                            <th><button id="btn-batal" onclick="window.location.href='Dokter.php'"><i class="fas fa-times"></i></button> FORM PENDAFTARAN DOKTER </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <div class="table-responsive">
                                    <form action="Dokter_Aksi.php" method="post" name="form" id="registrationForm" onsubmit="return validateForm()">
                                        <div class="form-group">
                                            <label for="namadokter">Nama Dokter</label>
                                            <input type="text" class="form-control" name="namadokter" placeholder="Masukkan Nama Dokter">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="spesialis" placeholder="Masukkan Spesialis">
                                        </div>
                                        <div class="form-group">
                                            <label for="jadwal">Jadwal</label>
                                            <input type="text" class="form-control" name="jadwal" placeholder="Masukkan Jadwal">
                                            <div style="display: flex; justify-content: flex-end; margin-top: 15px">
                                        <button id="submit-btn" type="submit" name="submitdokter"><i class="fas fa-save"></i> SIMPAN</button>
                                    </form>
                                </div>
                            </td>
                        </tr>
