...
<body>
    <header>
        Pendaftaran Rawat Jalan Rumah Sakit Harapan
    </header>
    <div class="container">
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <table class="table1 table table-bordered">
                    <thead>
                        <tr>
                            <th><button id="btn-batal" onclick="window.location.href='RawatJalan.php'"><i class="fas fa-times"></i></button> FORM PENDAFTARAN RAWAT JALAN </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <div class="table-responsive">
                                    <form action="RalanAksi.php" method="post">
